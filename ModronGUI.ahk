...
Gui, MyWindow:Add, Text, vdtCurrentRunTimeID x+2 w50, % dtCurrentRunTimeF
...
UpdateStatTimers()
{
	...
	dtCurrentLevelTime := T
	dtCurrentLevelTime += (A_TickCount - gPrevLevelTime)/1000,Seconds
	FormatTime dtCurrentLevelTimeF, %dtCurrentLevelTime%, HH:mm:ss
	GuiControl, MyWindow:, dtCurrentLevelTimeID, % dtCurrentLevelTimeF
}
